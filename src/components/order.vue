    ...
    <div id="order">
        <el-col :span="24" class="toolbar">
			<el-form :inline="true" :model="filters">
				<el-form-item>
					<el-input v-model="filters.name" placeholder="订单名称"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="users" highlight-current-row  @selection-change="selsChange">
			...
			<el-table-column prop="price" label="成交金额" sortable>
			</el-table-column>
			<el-table-column prop="ordernum" label="订单编号" sortable>
			</el-table-column>
			<el-table-column prop="time" label="生成时间" sortable>
			</el-table-column>
			<el-table-column prop="userString" label="用户id" sortable>
			</el-table-column>
...
export default {
    data(){
        return{
                ...
                users: [{id:1,name:'订单1',time:'2016-1-1',price:'10',userString:'21',ordernum:'1548551616'},
                    {id:2,name:'订单2',time:'2016-1-1',price:'10',userString:'11',ordernum:'1548551616'},
                    {id:3,name:'订单3',time:'2016-1-1',price:'10',userString:'13',ordernum:'1548551616'},
                    {id:4,name:'订单4',time:'2016-1-1',price:'10',userString:'14',ordernum:'1548551616'},
                    {id:5,name:'订单5',time:'2016-1-1',price:'10',userString:'14',ordernum:'1548551616'},
                    {id:6,name:'订单6',time:'2016-1-1',price:'10',userString:'15',ordernum:'1548551616'}],
				total: 6,
				page: 1,
                listLoading: false,
                dialogtitle:'',
...
#order .toolbar .el-form-item__content{
    line-height: 10vh;
}
#order .toolbar .el-form-item:first-child{
    margin-left: 1vw;
}
#order .el-table{
    width: 76vw;
