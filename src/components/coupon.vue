<template>
    <div id="coupon">
		...
		<el-table :data="users" highlight-current-row  @selection-change="selsChange">
			...
			<el-table-column prop="couponnum" label="订单编号" sortable>
			</el-table-column>
...
export default {
    data(){
        return{
                ...
                users: [{id:1,name:'订单1',time:'2016-1-1',price:'10',userString:'21',couponnum:'1548551616'},
                    {id:2,name:'订单2',time:'2016-1-1',price:'10',userString:'11',couponnum:'1548551616'},
                    {id:3,name:'订单3',time:'2016-1-1',price:'10',userString:'13',couponnum:'1548551616'},
                    {id:4,name:'订单4',time:'2016-1-1',price:'10',userString:'14',couponnum:'1548551616'},
                    {id:5,name:'订单5',time:'2016-1-1',price:'10',userString:'14',couponnum:'1548551616'},
                    {id:6,name:'订单6',time:'2016-1-1',price:'10',userString:'15',couponnum:'1548551616'}],
				total: 6,
				page: 1,
                listLoading: false,
                dialogtitle:'',
...
#coupon .toolbar .el-form-item__content{
    line-height: 10vh;
}
#coupon .toolbar .el-form-item:first-child{
    margin-left: 1vw;
}
#coupon .el-table{
    width: 76vw;
