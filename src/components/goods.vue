<template>
    <div id="goods">
		...
		<el-table :data="users" highlight-current-row  @selection-change="selsChange">
            ...
            <el-table-column prop="issell" label="是否上架" sortable>
			</el-table-column>
        ...
        <el-dialog
            ...
            <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
                ...
                <el-form-item label="是否上架" prop="issell">
					<el-select v-model="addForm.issell" placeholder="请选择是否上架">
...
export default {
    ...
    created(){
        var data = [{id:1,name:'汉堡',des:'微辣',price:'10',sort:'1',num:'10',issell:0},
                    {id:2,name:'汉堡1',des:'微辣',price:'10',sort:'1',num:'10',issell:1},
                    {id:3,name:'汉堡2',des:'微辣',price:'10',sort:'1',num:'10',issell:0},
                    {id:4,name:'汉堡3',des:'微辣',price:'10',sort:'1',num:'10',issell:0},
                    {id:5,name:'汉堡4',des:'微辣',price:'10',sort:'1',num:'10',issell:1},
                    {id:6,name:'汉堡5',des:'微辣',price:'10',sort:'1',num:'10',issell:0}]
        data.map(item=>{
            console.log(item);
            item.issell = item.issell?'是':'否';
        })
        this.users = data;
    },
    methods:{
...
#goods .toolbar .el-form-item__content{
    line-height: 10vh;
}
#goods .toolbar .el-form-item:first-child{
    margin-left: 1vw;
}
#goods .el-table{
    width: 76vw;
