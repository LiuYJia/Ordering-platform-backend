    ...
    <div id="member">
        <el-col :span="24" class="toolbar">
			<el-form :inline="true" :model="filters">
				<el-form-item>
					<el-input v-model="filters.name" placeholder="会员名"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="users" highlight-current-row  @selection-change="selsChange">
			...
			<el-table-column prop="year" label="注册时长" sortable>
			</el-table-column>
        ...
        <el-dialog
            ...
            <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
                ...
                <el-form-item label="注册时间" prop="price">
...
export default {
    ...
    created(){
        var data = [{id:1,name:'汉堡',time:'2016-1-1',year:'10'},
                    {id:2,name:'汉堡1',time:'2016-1-1',year:'10'},
                    {id:3,name:'汉堡2',time:'2016-1-1',year:'10'},
                    {id:4,name:'汉堡3',time:'2016-1-1',year:'10'},
                    {id:5,name:'汉堡4',time:'2016-1-1',year:'10'},
                    {id:6,name:'汉堡5',time:'2016-1-1',year:'10'}]
        data.map(item=>{
            console.log(item);
...
#member .toolbar .el-form-item__content{
    line-height: 10vh;
}
#member .toolbar .el-form-item:first-child{
    margin-left: 1vw;
}
#member .el-table{
    width: 76vw;
